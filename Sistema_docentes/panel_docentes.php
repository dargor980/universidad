    ...
    <div class="d-flex" id="wrapper" class="toggled">
        ...
        <div class="bg-dangeri border-right" id="sidebar-wrapper">
          ...
          <div class="list-group list-group-flush">
            ...
            <a href="#" class="list-group-item list-group-item-action bg-dangeri text-light">Events</a>
            <a href="#" class="list-group-item list-group-item-action bg-dangeri text-light">Profile</a>
            <a href="#" class="list-group-item list-group-item-action bg-dangeri text-light">Status</a>
          </div>
        </div>
        <!-- /#sidebar-wrapper -->
